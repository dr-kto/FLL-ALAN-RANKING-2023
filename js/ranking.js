...
{
    try {
        const base = 'https://docs.google.com/spreadsheets/d/1S-vjKR3KNMVWJhzt2sIG7LFdXDK2vFo122r72Z9YMFw'+'/gviz/tq?'+'tqx=out:txt&sheet='+'Ranking'
        const output = document.querySelector('.output')
        const query = encodeURIComponent('Select A,B,C LIMIT 42 ')
